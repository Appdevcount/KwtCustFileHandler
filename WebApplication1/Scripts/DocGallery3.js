...
if (getlanguageforalert == "en") {
    ...
    listadditionaldocumentsByALL = "All DDocuments";
    ...
    reviewButtonValue = "Documents Reviewed";
    ...
    listadditionaldocumentsByALL = "جميع الوثائق الإضافية";
    ...
    reviewButtonValue = "تمت مراجعة المستندات";
}
...
//        var reviewedMark = RenderReviewStatus(docTypeIdx, docNameIdx) + '';
//        var substringforreviewed = reviewedMark
...
//                '<span class="DOCNAME" onclientclick='+reviewedMark+' onclick="viewDoc(\'' + docTypes.doctype + '\',\'' + docTypes.uploadedDocuments[docNameIdx].name + '\',' + docTypeIdx + ',' + docNameIdx + ',\'' + id + '\')" title="' + docTypes.uploadedDocuments[docNameIdx].name + '">' + docser + ':' + shortname + '</span></td > ';
//        }
//        else {
//            docNamesHTML += '<td id="DOCNAMECELL_' + docTypeIdx + '_' + docNameIdx + '" class="DOCNAMECELL"><span class="DOCNAME"    onclick="viewDoc(\'' + docTypes.doctype + '\',\'' + docTypes.uploadedDocuments[docNameIdx].name + '\',' + docTypeIdx + ',' + docNameIdx + ',\'' + id + '\')" title="' + docTypes.uploadedDocuments[docNameIdx].name + '">' + docser + ':' + shortname + '</span></td>';
//        }
//    }
...
function renderDocNames(docTypeIdx) {
    ...
    //var testlink = UpdateReviewStatus(0, 1, this);
    for (var docNameIdx in docTypes.uploadedDocuments) {
        id = docTypes.uploadedDocuments[docNameIdx].FileNameId;
        var reviewedMark = RenderReviewStatus(docTypeIdx, docNameIdx) + '';
       // var res = reviewedMark.split("_")[3].split(" ");

       // var s = reviewedMark.split("_")[3].split(" ");
        
      //  testlink = "UpdateReviewStatus(" + docTypeIdx + ", " + docNameIdx + "," + RenderReviewStatus(docTypeIdx, docNameIdx)+")";
        ...
        if (bEnableItemAssociationStatus) {
            ...
            docNamesHTML += '<td  onclick="viewDoc(\'' + docTypes.doctype + '\',\'' + docTypes.uploadedDocuments[docNameIdx].name + '\',' + docTypeIdx + ',' + docNameIdx + ',\'' + id + '\');" id="DOCNAMECELL_' + docTypeIdx + '_' + docNameIdx + '" class="DOCNAMECELL"><span class="DOCNAME"  title="' + docTypes.uploadedDocuments[docNameIdx].name + '">' + docser + ':' + shortname + '</span>' +
...
$('#docNamesTable tr td').click(function () {
...

{
    ...
    if (CurrentDocument.DocTypeIdx != docTypeIdx || CurrentDocument.DocNameIdx != docNameIdx) {
      ...
      //  RenderReviewStatus(docTypeIdx, docNameIdx);
    }
}
