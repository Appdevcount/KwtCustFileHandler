...
<head>
    <meta charset="utf-8" />
    <title></title>
    <script src="Scripts/1.12.4.min.js"></script>
...
<%--    <script type="text/javascript" charset="utf8" src="http://code.jquery.com/jquery-1.12.4.js"></script>
  ...
  <%--  <script src="Scripts/1.12.4.min.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function ItemDeselection()
        {
        $(".Itemselctedcheckbox").change(function () {
      //      debugger;
            $(".Itemselctedcheckbox:visible").each(function () {
                if (!$(this).is(":checked")) {
        ...
        function DocumentsItemAssocaitionDeselection() {
   ...
   var urlf = 'http://10.10.26.226:8024/api/itemassociation/GetDocumentDetails?DocId=' + <%="'"+decryptedDocid.ToString()+"'"%>+'&DeclId=' + <%="'"+DeclarationId.ToString()+"'"%>+'';///?id= ' + check +'',
       ...
       //     http://localhost:1555/
            //  alert(urlf);
            var DocumentsTable = $('#DocumentsTable').removeAttr('width').DataTable({
            //"scrollY": '200',
            ////"scrollX": 'true',
            //"scrollX": '10vh',
            //'scrollCollapse': true,
            ...
            'columns': [
                {
                    ...
                    "render": function (data, type, row, meta) {
                        var checkbox = $("<input/>", {
                            ...
                            "value": row[0],
                            "onClick":"DocumentsItemAssocaitionDeselection()"
        ...
        $('#AssociateDocItems').on('click', function () {
            ...
            $('#DocumentsTable').find('tbody tr.selected').each(function () {
                ...
                $('#ItemTable').find('tbody tr.selected ').each(function () {
                    //debugger;
                    itemid = $(this).find('td:nth-child(1)').find('input').attr('value');
                    itemtext = $('#ItemTable').find('tbody tr.selected ').find('td:nth-child(2)').html();
...
<body>
    ...
    <div style="padding-top:1%">
        <p class="mcbutton" style="text-align:center">
           Items and  Documents Association
        </p>
    </div>
    <div style="width: 60%;  padding-top:1%  ;  padding-left:20%;padding-right:10%">
...
<div style="width: 4%;float: left;padding-top:10%;padding-left:0.75%;"  > 

    <div id="dialog" style="display: none"></div>
    <%if (checkflag == "true")
        {%>
        <button type="button"  title="Associate"  class="mcbutton" style="height: 30px; background-color:white;" id="AssociateDocItems" > <img src="Images/connectg.png" style="width: 80%;" class="imgc"/> </button>
        <button type="button"  title="DisAssociate"  class="mcbutton" style="height: 30px; background-color:white;"  id="DisassociateDocItems" ><img src="Images/connectr.png" style="width: 80%;" class="imgc"/> </button>
        <button type="button"  title="Save" class="mcbutton" style="height: 30px; background-color:white; " id="SaveItems"  ><img src="Images/saveb.png" style="width: 80%;" class="imgc" /></button>
     <button type="button"  onclick="return self.close()" title="Close" class="mcbutton" style="height: 30px; background-color:white;" id="Close"  ><img src="Images/RS_Rejected.png" style="width: 80%;" class="imgc" /></button>
  ...
  <div style="width: 46%; float: left; border-style: double; border-color: lightgrey; height:360px; padding-top:3%" >
                     <div id="Header" style=" margin-top: 13%; margin-bottom: 1%; ">
                    <table width="98.5%" cellpadding="0" cellspacing="0" style="margin-top: -80px;">
                        <tbody>
                            <tr width="100%">
                                <td valign="bottom" width="8">
 ...
 <table id="ItemTable" class=" table display select">
    ...
    <div style="padding-top:1%">
        <p class="mcbutton" style="text-align:right">
 جمعية العناصر والوثائق
        </p>
    </div>
  <div style="width: 60%;padding-left:20%;   padding-top:1%;            padding-right:19%">
...
<!-- margin-left:4px; -->
    ...
    <%if (checkflag == "true")
        {%>
        <button type="button" title=" إرفاق"  class="mcbutton" style="height: 30px; background-color:white;" id="AssociateDocItems" > <img src="Images/connectg.png" style="width: 80%;" class="imgc"/> </button>
        <button type="button" title=" عدم ربط"  class="mcbutton" style="height: 30px;  background-color:white;" id="DisassociateDocItems" ><img src="Images/connectr.png" style="width: 80%;" class="imgc"/> </button>
        <button type="button" title="حفظ" class="mcbutton" style="height: 30px; background-color:white;" id="SaveItems"  ><img src="Images/saveb.png" style="width: 80%;" class="imgc" /></button>
       <button type="button" title=" اغلاق"  onclick="return self.close()" title="Close" class="mcbutton" style="height: 30px; background-color:white;" id="Close"  ><img src="Images/RS_Rejected.png" style="width: 80%;" class="imgc" /></button>
